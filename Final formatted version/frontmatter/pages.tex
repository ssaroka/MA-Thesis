...
\input{frontmatter/abstract} %did this

%4. Dedication, Acknowledgement(s) and/or Preface (all optional)

%\input{frontmatter/dedication}
\input{frontmatter/acknowledgement} %did this
...
\input{frontmatter/contents} %no changes needed here, apparently, since this is generated automatically


%6. List of Tables, with titles and page references (if applicable)

\input{frontmatter/tables} %no changes needed here for same reason


%7. List of Figures or Illustrations, with titles and page references (if applicable)

\input{frontmatter/figures} %no changes needed here for same reason
