...
abstract: "Only changes from MA full text v3.2 are that figures have been altered and saved for compliance with Grad School requirements."
...
rm(list=ls()) 
require("knitr")
opts_knit$set(root.dir = "C:/Users/Steven Saroka/Documents/Own Research/Master's Work/Data")
library(dplyr)
library(tidyverse)
library(readxl)
library(ggplot2)
...
ggsave("fig1_avgfatplot.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
```
...
ggsave("fig2.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
```
...
fig3 <- ggplot(data = fd1, aes(x = year, y = avg)) + 
  geom_line() +
  geom_point() +
...
ggsave("fig3.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
...
fd2alt <- fd2[-5,]
fig4 <- ggplot(data = fd2alt, aes(x = year, y = avg)) + 
  geom_line() +
  geom_point() +
 # ggrepel::geom_text_repel(aes(label = avg), color = "black", size = 2.5, segment.color = "grey") +
  labs(x = "Year", y = "Average Deaths", caption = "Note: 1994 dropped due to distortionary effects of Rwandan Genocide.")+ 
  theme_bw() + 
  theme(axis.title=element_text(size=8))

fig4

ggsave("fig4.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
```
...
fig5 <- ggplot(data = fd3, aes(x = year, y = nbv)) + 
  geom_line() +
  geom_point() +
  ggrepel::geom_text_repel(aes(label = nbv), color = "black", segment.color = "grey") +
  labs(x = "Year", y = "Number of PRIO-GRID Cells")+ 
  theme_bw() + 
  theme(axis.title=element_text(size=8))

fig5

ggsave("fig5.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
...
fig6 <- ggplot(data = fd4, aes(x = year, y = avg)) + 
  geom_point() +
...
ggsave("fig6.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
...
fig7 <- ggplot(data = fd5, aes(x = year, y = avg)) + 
  geom_point() +
  ggrepel::geom_text_repel(aes(label = avg), color = "black", segment.color = "grey") +
  labs(x = "Year", y = "Average")+ 
  theme_bw() + 
...
ggsave("fig7.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
...
fig8 <- ggplot(sim_output, aes(x = as.factor(diamonds), y = pe)) + 
  geom_point() + 
  geom_errorbar(aes(x=as.factor(diamonds),ymax = hi, ymin = lo), width=.1) +
  labs(x = "Values of Diamond Indicator", y = "Probability of One-Sided State Violence") +
  theme_bw() + 
  theme(axis.title=element_text(size=8))
fig8

ggsave("fig8.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
...
fig41 <- ggplot(data = fd2, aes(x = year, y = avg)) + 
  geom_line() +
  geom_point() +
 # ggrepel::geom_text_repel(aes(label = avg), color = "black", size = 2.5, segment.color = "grey") +
  labs(x = "Year", y = "Average Deaths", caption = "Note: This figure includes 1994 data.")+ 
  theme_bw() #make the plot background blank w/grid lines

fig41

ggsave("appfig4_1.png", path = "C:/Users/Steven Saroka/Documents/Master's Work/Final formatted version/My Thesis/Masters Thesis 2")
